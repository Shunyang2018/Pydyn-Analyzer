...
def get_raw_dyn_downhill(filename):
    ...
    traj_coord = []
    point_order = []
    total_coord_list,total_energy_list,atom_list = [],[],[]
    completeness = True
...
def read_anal_file():
    ...
    global struct_list
    anal_file = open('anal.txt')
    anal = anal_file.readlines()
    print('The anal file has defined ',anal.count('next\n')+1,' different outcomes')
